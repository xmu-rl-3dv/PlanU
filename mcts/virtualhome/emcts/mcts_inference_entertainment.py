...
import virtual_home
from mcts.virtualhome.dmcts.dmcts_policy_v2 import LLMAgent, LanguageNode
...
def main():
    ...
    writer = SummaryWriter(f"./results_grab/Model={args.base_model}/entertainment/mcts/seed={args.seed}/stochastic={args.stochastic}/")
    writer.add_text(
        "hyperparameters",
